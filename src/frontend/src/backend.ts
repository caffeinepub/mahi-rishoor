...
export class Backend implements backendInterface {
    ...
    async getProducts(arg0: Category | null): Promise<Array<Product>> {
        if (this.processError) {
            try {
                const result = await this.actor.getProducts(to_candid_opt_n10(this._uploadFile, this._downloadFile, arg0));
...
function from_candid_variant_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "lawn" in value ? Category.lawn : "suit" in value ? Category.suit : "shawl" in value ? Category.shawl : value;
}
...
function to_candid_opt_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Category | null): [] | [_Category] {
...
function to_candid_variant_n4(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Category): {
    ...
    return value == Category.lawn ? {
        lawn: null
    } : value == Category.suit ? {
        suit: null
    } : value == Category.shawl ? {
        shawl: null
    } : value;
}
